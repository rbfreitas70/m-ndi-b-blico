...
export const STORIES = [
  ...
  // ===== NT CAP 1: NASCIMENTO =====
  {
    ...
    xpReward: 80,
    dracmasReward: 35,
    verse: 'Alegre-se, agraciada! O Senhor está com você! — Lucas 1:28',
    description: 'Um anjo traz a notícia mais incrível da história!',
    slides: [
      { bg: '#E8EAF6', scene: 'angel_mary', text: 'O anjo Gabriel apareceu para Maria: "Você terá um filho chamado Jesus!"' },
      { bg: '#FFF8E1', scene: 'mary_joy', text: 'Maria ficou surpresa, mas disse: "Que seja como Deus quer!" Que fé!' },
    ],
    quiz: [
      { q: 'Qual anjo visitou Maria?', opts: ['Miguel', 'Gabriel', 'Rafael', 'Uriel'], ans: 1 },
      { q: 'Que nome o bebê deveria ter?', opts: ['João', 'José', 'Jesus', 'Tiago'], ans: 2 },
    ],
  },
  {
    id: 'jesus_birth',
    ...
    xpReward: 90,
    dracmasReward: 40,
    verse: 'Hoje nasceu o Salvador, que é Cristo, o Senhor! — Lucas 2:11',
    description: 'Jesus nasce numa manjedoura sob a estrela mais brilhante!',
    slides: [
      { bg: '#E8EAF6', scene: 'bethlehem', text: 'Maria e José viajaram até Belém, mas não havia lugar para eles na hospedaria.' },
      { bg: '#FFF3E0', scene: 'manger', text: 'Jesus nasceu num estábulo e foi deitado numa manjedoura, entre os animais.' },
      { bg: '#E8EAF6', scene: 'shepherds', text: 'Anjos apareceram aos pastores: "Nasceu o Salvador!" Eles correram para ver!' },
    ],
    quiz: [
      { q: 'Em que cidade Jesus nasceu?', opts: ['Nazaré', 'Jerusalém', 'Belém', 'Jericó'], ans: 2 },
      { q: 'Onde o bebê Jesus foi deitado?', opts: ['Num berço', 'Numa manjedoura', 'Numa cama', 'Num cesto'], ans: 1 },
      { q: 'Quem recebeu a notícia dos anjos?', opts: ['Os reis', 'Os pastores', 'Os soldados', 'Os pescadores'], ans: 1 },
    ],
  },
  {
    id: 'wise_men',
    chapterId: 'nativity',
    title: 'Os Magos do Oriente',
    emoji: '🐪',
    color: '#5C6BC0',
    unlockXP: 1270,
    xpReward: 80,
    dracmasReward: 35,
    verse: 'Vimos a sua estrela no Oriente e viemos adorá-lo. — Mateus 2:2',
    description: 'Sábios seguem uma estrela para encontrar o menino Jesus!',
    slides: [
      { bg: '#0D0221', scene: 'star_east', text: 'Magos do Oriente viram uma estrela especial e a seguiram por muitos dias.' },
      { bg: '#FFF8E1', scene: 'magi_gifts', text: 'Eles encontraram Jesus e deram presentes: ouro, incenso e mirra!' },
    ],
    quiz: [
      { q: 'O que guiou os magos até Jesus?', opts: ['Um mapa', 'Uma estrela', 'Um anjo', 'Uma pomba'], ans: 1 },
      { q: 'Qual destes foi um presente dos magos?', opts: ['Prata', 'Ouro', 'Diamante', 'Pérolas'], ans: 1 },
    ],
  },
  ...
  // ===== NT CAP 2: MILAGRES =====
  {
    ...
    xpReward: 90,
    dracmasReward: 40,
    verse: 'Este é o meu Filho amado, em quem me agrado. — Mateus 3:17',
    description: 'João batiza Jesus no rio Jordão e o céu se abre!',
    slides: [
      { bg: '#E0F7FA', scene: 'jordan_river', text: 'João Batista batizava as pessoas no rio Jordão. Um dia, Jesus chegou!' },
      { bg: '#E3F2FD', scene: 'dove_heaven', text: 'Quando Jesus foi batizado, o céu se abriu e o Espírito desceu como uma pomba!' },
    ],
    quiz: [
      { q: 'Quem batizou Jesus?', opts: ['Pedro', 'João Batista', 'Paulo', 'Tiago'], ans: 1 },
      { q: 'Em que rio Jesus foi batizado?', opts: ['Nilo', 'Eufrates', 'Jordão', 'Tigre'], ans: 2 },
    ],
  },
  {
    id: 'wedding_cana',
    ...
    xpReward: 90,
    dracmasReward: 40,
    verse: 'Façam tudo o que ele mandar. — João 2:5',
    description: 'O primeiro milagre de Jesus numa festa de casamento!',
    slides: [
      { bg: '#FCE4EC', scene: 'wedding', text: 'Jesus foi a um casamento em Caná. No meio da festa, o vinho acabou!' },
      { bg: '#FFF3E0', scene: 'water_wine', text: 'Jesus mandou encher jarros com água — e a água virou o melhor vinho!' },
    ],
    quiz: [
      { q: 'Onde aconteceu o primeiro milagre de Jesus?', opts: ['Num templo', 'Num casamento', 'Num barco', 'Numa praça'], ans: 1 },
      { q: 'O que Jesus transformou em vinho?', opts: ['Suco', 'Leite', 'Água', 'Mel'], ans: 2 },
    ],
  },
  {
    id: 'loaves_fishes',
    ...
    xpReward: 100,
    dracmasReward: 45,
    verse: 'Todos comeram e ficaram satisfeitos. — Mateus 14:20',
    description: 'Jesus alimenta 5 mil pessoas com 5 pães e 2 peixes!',
    slides: [
      { bg: '#E8F5E9', scene: 'crowd_hill', text: 'Uma multidão de mais de 5 mil pessoas seguia Jesus, e todos estavam com fome.' },
      { bg: '#FFF8E1', scene: 'bread_fish', text: 'Um menino tinha 5 pães e 2 peixes. Jesus agradeceu a Deus e multiplicou tudo!' },
    ],
    quiz: [
      { q: 'Quantos pães o menino tinha?', opts: ['2', '5', '7', '12'], ans: 1 },
      { q: 'Quantas pessoas Jesus alimentou?', opts: ['100', '500', '1000', '5000'], ans: 3 },
    ],
  },
  {
    id: 'calm_storm',
    ...
    xpReward: 100,
    dracmasReward: 45,
    verse: 'Quem é este que até o vento e o mar lhe obedecem? — Marcos 4:41',
    description: 'No meio da tempestade, Jesus mostra seu poder sobre a natureza!',
    slides: [
      { bg: '#37474F', scene: 'storm_boat', text: 'Uma tempestade terrível atingiu o barco. Os discípulos estavam apavorados!' },
      { bg: '#E0F7FA', scene: 'calm_sea', text: 'Jesus se levantou e disse: "Acalme-se!" E o mar ficou totalmente tranquilo.' },
    ],
    quiz: [
      { q: 'O que Jesus fez na tempestade?', opts: ['Fugiu', 'Acalmou o mar', 'Remou mais rápido', 'Chamou ajuda'], ans: 1 },
      { q: 'O que obedeceu a Jesus?', opts: ['Os peixes', 'O vento e o mar', 'Os pássaros', 'As nuvens'], ans: 1 },
    ],
  },
  ...
  // ===== NT CAP 3: PARÁBOLAS =====
  {
    ...
    xpReward: 90,
    dracmasReward: 40,
    verse: 'Ame o seu próximo como a si mesmo. — Lucas 10:27',
    description: 'Quem é o verdadeiro amigo na hora do perigo?',
    slides: [
      { bg: '#FFF3E0', scene: 'road_jericho', text: 'Um homem foi assaltado na estrada. Duas pessoas passaram e não ajudaram!' },
      { bg: '#E8F5E9', scene: 'samaritan_help', text: 'Um samaritano parou, cuidou dele e pagou sua hospedagem. Esse é amar o próximo!' },
    ],
    quiz: [
      { q: 'Quem ajudou o homem ferido?', opts: ['Um sacerdote', 'Um samaritano', 'Um soldado', 'Um rei'], ans: 1 },
      { q: 'O que essa história ensina?', opts: ['Ter dinheiro', 'Viajar com cuidado', 'Amar o próximo', 'Andar em grupo'], ans: 2 },
    ],
  },
  {
    id: 'prodigal_son',
    ...
    xpReward: 90,
    dracmasReward: 40,
    verse: 'Este meu filho estava perdido e foi achado! — Lucas 15:24',
    description: 'A história do pai que nunca deixou de amar!',
    slides: [
      { bg: '#FFF8E1', scene: 'son_leaves', text: 'Um filho pegou sua herança e foi embora gastar tudo, deixando o pai triste.' },
      { bg: '#EFEBE9', scene: 'pigs_field', text: 'O dinheiro acabou e ele ficou cuidando de porcos, com fome. Decidiu voltar.' },
      { bg: '#FFF3E0', scene: 'father_hug', text: 'O pai o viu de longe, correu e o abraçou! Fez uma festa enorme de alegria!' },
    ],
    quiz: [
      { q: 'O que o filho fez com a herança?', opts: ['Guardou', 'Gastou tudo', 'Doou', 'Investiu'], ans: 1 },
      { q: 'O que o pai fez quando o filho voltou?', opts: ['Brigou', 'Fechou a porta', 'O abraçou com festa', 'O ignorou'], ans: 2 },
    ],
  },
  {
    id: 'zacchaeus',
    ...
    xpReward: 80,
    dracmasReward: 35,
    verse: 'Hoje preciso ficar na sua casa. — Lucas 19:5',
    description: 'O homem baixinho que subiu na árvore para ver Jesus!',
    slides: [
      { bg: '#E8F5E9', scene: 'sycamore_tree', text: 'Zaqueu era baixinho e subiu numa árvore para conseguir ver Jesus passar!' },
      { bg: '#FFF8E1', scene: 'zacchaeus_house', text: 'Jesus foi à casa dele. Zaqueu mudou de vida e devolveu o que tinha tomado!' },
    ],
    quiz: [
      { q: 'Por que Zaqueu subiu na árvore?', opts: ['Para fugir', 'Para colher frutas', 'Para ver Jesus', 'Para dormir'], ans: 2 },
      { q: 'O que Zaqueu fez depois de conhecer Jesus?', opts: ['Fugiu da cidade', 'Devolveu o que tomou', 'Escondeu o dinheiro', 'Construiu uma casa'], ans: 1 },
    ],
  },

  // ===== NT CAP 4: PÁSCOA E IGREJA =====
  {
    id: 'resurrection',
    chapterId: 'easter',
    ...
    xpReward: 120,
    dracmasReward: 60,
    verse: 'Ele não está aqui; ressuscitou! — Lucas 24:6',
    description: 'A maior vitória de todas: Jesus vence a morte!',
    slides: [
      { bg: '#4527A0', scene: 'cross_hill', text: 'Jesus morreu na cruz por amor a todos nós. Seus amigos ficaram muito tristes.' },
      { bg: '#E8EAF6', scene: 'empty_tomb', text: 'No terceiro dia, as mulheres foram ao túmulo — e ele estava vazio!' },
      { bg: '#FFF8E1', scene: 'risen_jesus', text: 'Jesus estava vivo! Ele apareceu aos discípulos. Que alegria gigante!' },
    ],
    quiz: [
      { q: 'O que aconteceu no terceiro dia?', opts: ['Jesus ressuscitou', 'Houve uma festa', 'Choveu muito', 'Nada'], ans: 0 },
      { q: 'Como estava o túmulo?', opts: ['Fechado', 'Vazio', 'Cheio de flores', 'Guardado'], ans: 1 },
    ],
  },
  {
    id: 'pentecost',
    ...
    xpReward: 110,
    dracmasReward: 55,
    verse: 'Todos ficaram cheios do Espírito Santo. — Atos 2:4',
    description: 'O Espírito Santo chega como fogo e nasce a Igreja!',
    slides: [
      { bg: '#3E2723', scene: 'upper_room', text: 'Os discípulos estavam reunidos orando, esperando a promessa de Jesus.' },
      { bg: '#1a237e', scene: 'tongues_fire', text: 'De repente, línguas de fogo apareceram sobre cada um! Era o Espírito Santo!' },
      { bg: '#FFF8E1', scene: 'risen_jesus', text: 'Naquele dia, 3 mil pessoas creram em Jesus. A Igreja tinha nascido!' },
    ],
    quiz: [
      { q: 'Como o Espírito Santo apareceu?', opts: ['Como chuva', 'Como línguas de fogo', 'Como vento frio', 'Como neve'], ans: 1 },
      { q: 'Quantas pessoas creram naquele dia?', opts: ['100', '500', '3 mil', '10 mil'], ans: 2 },
    ],
  },
];
